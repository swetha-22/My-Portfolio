...
function Hero() {
  return (
    <section id="hero" className="pb-28 mt-10 flex px-6 lg:px-10">
        ...
        <div className="flex gap-2 align-center flex-wrap md:flex-nowrap">
          <div className="lg:w-[100%] text-zinc-900 dark:text-zinc-100 self-center">
            ...
            <div className="flex gap-2 mt-6">
              <a
                href="#projects"
                className="px-6 py-3 border border-black hover:bg-primary hover:text-white hover:border-primary dark:border-white font-medium transition-all duration-300 rounded-lg"
              >
                Projects
              </a>
              <a
