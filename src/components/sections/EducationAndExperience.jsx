    ...
    <section id="education-and-experience" className="mt-20 mx-4 lg:mx-20 flex flex-col md:flex-row gap-4 md:gap-2">
      ...
      <div className="w-full md:w-[80%]">
        ...
        <h4 className="text-xl dark:text-white mb-4 font-bold flex gap-2 items-center">
          <FaLandmark className="text-xl text-primary dark:text-primaryLight" />
          Education
        </h4>
        {/* =========== EDUCATION LIST =========== */}
      ...
      <div className="w-full">
        {/* =========== EXPERIENCE TITLE =========== */}
        <h4 className="text-xl dark:text-white mb-4 font-bold flex gap-2 items-center">
          <FaBuildingUser className="text-2xl text-primary dark:text-primaryLight" />
          Experience
        </h4>
                      ...
                      {exp.descriptions.map((desc, index) => {
                        return (
                          <li className="flex space-x-3" key={index}>
                            <svg
                              className="flex-shrink-0 size-4 mt-0.5 text-primary dark:text-primaryLight"
